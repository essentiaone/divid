...
import (
	...
	peerpkg "github.com/DiviProject/divid/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*diviutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *diviutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *diviutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *diviutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
