...
/*
divid is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means divid will work 'out of
...
parsed when divid starts up.  By default, the configuration file is located at
~/.divid/divid.conf on POSIX-style operating systems and %LOCALAPPDATA%\divid\divid.conf
...
Application Options:
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --minrelaytxfee=      The minimum transaction fee in DIVI/kB to be
