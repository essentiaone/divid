...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*diviutil.Block, error) {
	...
	blocks := make([]*diviutil.Block, 0, 256)
	genesis := diviutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
