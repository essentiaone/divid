...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DiviProject/divid/connmgr)
...
```bash
$ go get -u github.com/DiviProject/divid/connmgr
```
