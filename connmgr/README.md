...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/essentiaone/divid/connmgr)
...
```bash
$ go get -u github.com/essentiaone/divid/connmgr
```
