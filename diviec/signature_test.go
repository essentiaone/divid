...
// The cases are borrowed from github.com/fjl/diviec-issue.
...
func TestRFC6979(t *testing.T) {
	...
	// - https://github.com/oleganza/CoreBitcoin/blob/e93dd71207861b5bf044415db5fa72405e7d8fbc/CoreBitcoin/DIVIKey%2BTests.m#L23-L49
	tests := []struct {
		key       string
		msg       string
		nonce     string
