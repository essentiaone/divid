...
func (msg *MsgGetAddr) DiviDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	return nil
}

// DiviEncode encodes the receiver to w using the bitcoin protocol encoding.
// This is part of the Message interface implementation.
func (msg *MsgGetAddr) DiviEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	return nil
}
