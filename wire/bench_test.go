...
func BenchmarkDecodeGetHeaders(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.DiviEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgGetHeaders.DiviEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
	...
	for i := 0; i < b.N; i++ {
		r.Seek(0, 0)
		msg.DiviDecode(r, pver, LatestEncoding)
	}
}
...
func BenchmarkDecodeHeaders(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.DiviEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgHeaders.DiviEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeGetBlocks(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.DiviEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgGetBlocks.DiviEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeAddr(b *testing.B) {
	...
	// Serialize it so the bytes are available to test the decode below.
	var bb bytes.Buffer
	if err := ma.DiviEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgAddr.DiviEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeInv(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.DiviEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgInv.DiviEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeNotFound(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.DiviEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgNotFound.DiviEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeMerkleBlock(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.DiviEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgMerkleBlock.DiviEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
