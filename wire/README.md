...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DiviProject/divid/wire)
=======
...
[here](https://blog.conformal.com/btcwire-the-bitcoin-wire-protocol-package-from-divid/).
...
```bash
$ go get -u github.com/DiviProject/divid/wire
```
