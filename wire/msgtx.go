...
func (msg *MsgTx) DiviDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count == 0 && enc == WitnessEncoding {
		...
		if flag[0] != 0x01 {
			...
			return messageError("MsgTx.DiviDecode", str)
		}
...
// the Version field in the transaction.  This function differs from DiviDecode
// in that DiviDecode decodes from the bitcoin wire protocol as it was sent
...
func (msg *MsgTx) DiviEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
...
// the transaction.  This function differs from DiviEncode in that DiviEncode
...
func (msg *MsgTx) Serialize(w io.Writer) error {
	...
	//
	// Passing a encoding type of WitnessEncoding to DiviEncode for MsgTx
