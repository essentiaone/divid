...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.DiviEncode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.DiviDecode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.DiviEncode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.DiviDecode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.DiviEncode(w, test.pver, BaseEncoding)
		...
		err = msg.DiviDecode(r, test.pver, BaseEncoding)
