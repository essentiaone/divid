...
func (msg *MsgAlert) DiviDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	var err error
...
// This is part of the Message interface implementation.
func (msg *MsgAlert) DiviEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	var err error
	...
	if slen == 0 {
		return messageError("MsgAlert.DiviEncode", "empty serialized payload")
	}
