...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/essentiaone/divi/mining/cpuminer)
=======
...
```bash
$ go get -u github.com/essentiaone/divi/mining/cpuminer
```
