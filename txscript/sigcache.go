...
func (s *SigCache) Exists(sigHash chainhash.Hash, sig *diviec.Signature, pubKey *diviec.PublicKey) bool {
	s.RLock()
...
func (s *SigCache) Add(sigHash chainhash.Hash, sig *diviec.Signature, pubKey *diviec.PublicKey) {
	s.Lock()
	defer s.Unlock()
