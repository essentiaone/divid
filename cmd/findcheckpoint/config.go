...
var (
	dividHomeDir     = diviutil.AppDataDir("divid", false)
	defaultDataDir  = filepath.Join(dividHomeDir, "data")
...
type config struct {
	DataDir        string `short:"b" long:"datadir" description:"Location of the divid data directory"`
...
// time of writing, divid currently places blocks for testnet version 3 in the
