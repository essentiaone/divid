...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DiviProject/divid/chaincfg)
...
func main() {
	...
	addr, err := diviutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
	if err != nil {
		log.Fatal(err)
	}
	fmt.Println(addr)
...
```bash
$ go get -u github.com/DiviProject/divid/chaincfg
```
