...
func GetBlockWeight(blk *diviutil.Block) int64 {
...
func GetTransactionWeight(tx *diviutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *diviutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
