...
func storeFilter(dbTx database.Tx, block *diviutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *diviutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *diviutil.Block,
