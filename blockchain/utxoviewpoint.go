...
func (view *UtxoViewpoint) AddTxOut(tx *diviutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *diviutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *diviutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *diviutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *diviutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *diviutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *diviutil.Tx) (*UtxoViewpoint, error) {
