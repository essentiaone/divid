...
// diviutil.Block.  This is largely borrowed from the test code in dividb.
func loadBlocks(filename string) (blocks []*diviutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = diviutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
