...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/htkachuk/divi/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/htkachuk/divi/blockchain/fullblocktests
```
