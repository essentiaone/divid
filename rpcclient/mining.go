...
func (c *Client) SubmitBlockAsync(block *diviutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *diviutil.Block, options *btcjson.SubmitBlockOptions) error {
