...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/htkachuk/divi/integration/rpctest)
...
```bash
$ go get -u github.com/htkachuk/divi/integration/rpctest
```
