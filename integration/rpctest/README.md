...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/essentiaone/divi/integration/rpctest)
...
```bash
$ go get -u github.com/essentiaone/divi/integration/rpctest
```
