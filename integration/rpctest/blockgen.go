...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr diviutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*diviutil.Tx, error) {
...
func CreateBlock(prevBlock *diviutil.Block, inclusionTxs []*diviutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr diviutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*diviutil.Block, error) {
	...
	blockTxns := []*diviutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := diviutil.NewBlock(&block)
