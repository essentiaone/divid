...
function which allows a divilog.Logger to be specified.  For example, logging at
...
(https://godoc.org/github.com/DiviProject/divid/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
