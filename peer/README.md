...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DiviProject/divid/peer)
...
```bash
$ go get -u github.com/DiviProject/divid/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/DiviProject/divid/peer#example-package--NewOutboundPeer)
