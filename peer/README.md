...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/essentiaone/divid/peer)
...
```bash
$ go get -u github.com/essentiaone/divid/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/essentiaone/divid/peer#example-package--NewOutboundPeer)  
