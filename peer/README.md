...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/htkachuk/divi/peer)
...
```bash
$ go get -u github.com/htkachuk/divi/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/htkachuk/divi/peer#example-package--NewOutboundPeer)  
