...
reason, the divid suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire divid
...
One of the major design goals of all core divid packages is to aim for complete
...
commits](https://github.com/DiviProject/divid/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into divid.
...
Rejoice as you will now be listed as a [contributor](https://github.com/DiviProject/divid/graphs/contributors)!
...
[ISC license](https://github.com/DiviProject/divid/blob/master/LICENSE).  This is
the same license as all of the code in the divid suite.
