...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/essentiaone/btcwallet).
...
such as [btcwallet](https://github.com/essentiaone/btcwallet) for inter-process
...
[btcrpcclient](https://github.com/essentiaone/btcrpcclient) package.
...
[btcrpcclient](https://github.com/essentiaone/btcrpcclient) package to connect with
