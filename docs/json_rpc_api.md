...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/htkachuk/btcwallet).
...
such as [btcwallet](https://github.com/htkachuk/btcwallet) for inter-process
...
[btcrpcclient](https://github.com/htkachuk/btcrpcclient) package.
...
[btcrpcclient](https://github.com/htkachuk/btcrpcclient) package to connect with
...
import (
	"github.com/htkachuk/btcrpcclient"
